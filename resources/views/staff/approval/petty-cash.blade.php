...
<x-grid>
    ...
    <x-grid-col>
        <x-show-group>
            <x-slot name="label">Payment To</x-slot>
            <x-slot name="value">{{$data->Payment_to}}</x-slot>
        </x-show-group>
    </x-grid-col>
    <x-grid-col>
        <x-show-group>
            <x-slot name="label">Paying Bank Account</x-slot>
            <x-slot name="value">{{$data->Paying_Bank_Account}}</x-slot>
        </x-show-group>
    </x-grid-col>
    <x-grid-col>
        <x-show-group>
            <x-slot name="label">Total VAT Amount</x-slot>
            <x-slot name="value">{{$data->Total_VAT_Amount}}</x-slot>
        </x-show-group>
    </x-grid-col>
    <x-grid-col>
        <x-show-group>
