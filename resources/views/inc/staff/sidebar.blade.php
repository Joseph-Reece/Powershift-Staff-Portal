<div class="bg-theme1 sidebarx min-h-screen h-full w-full sm:w-full whitespace-nowrap">
    <div class="text-white sticky top-12 overflow-y-auto z-40 max-h-screen">
        ...
        <div class="pl-1 border-b border-t">
            ...
            <div class="pl-4">
                ...
                <x-jet-dropdown-link href="/staff/p-nine" class=" border-l pl-1 flex items-center gap-1 {{\Request::is('*staff/p-nine')? 'bg-theme2':''}}">
                    <x-heroicon-o-cash/>
                    P9
                </x-jet-dropdown-link>
                <x-jet-dropdown-link href="/staff/attendance" class=" border-l pl-1 flex items-center gap-1 {{\Request::is('*staff/attendance')? 'bg-theme2':''}}">
                    <x-heroicon-o-users/>
                    Attendance
                </x-jet-dropdown-link>
                <x-jet-dropdown-link href="/staff/appraisal" class=" border-l pl-1 flex items-center gap-1 {{\Request::is('*staff/appraisal*')? 'bg-theme2':''}}">
        ...
        <div class="pl-1 border-b border-t">
            ...
            <div class="pl-4">
                <x-jet-dropdown-link href="/staff/requisition/imprest" class="border-b border-l pl-1 flex items-center gap-1 {{\Request::is('*staff/requisition/imprest/*') || \Request::is('*staff/requisition/imprest')? 'bg-theme2':''}}">
                    <x-heroicon-o-cash/>
                    Imprest Requisition
                </x-jet-dropdown-link>
                <x-jet-dropdown-link href="/staff/requisition/imprest-surrender" class="border-b border-l borderx-t pl-1 flex items-center gap-1 {{\Request::is('*staff/requisition/imprest-surrender*')? 'bg-theme2':''}}">
                    <x-heroicon-o-receipt-refund/>
                    Imprest Surrender
                </x-jet-dropdown-link>
                <x-jet-dropdown-link href="/staff/requisition/claim" class=" border-l pl-1 flex items-center gap-1  {{\Request::is('*staff/requisition/claim*')? 'bg-theme2':''}}">
                    <x-heroicon-o-cash/>
                    Staff Claims
                </x-jet-dropdown-link>
            </div>
        ...
        <div class="pl-1 border-b border-t">
            ...
            <div class="pl-4">
                <x-jet-dropdown-link href="/staff/requisition/purchase" class="border-b border-l pl-1 flex items-center gap-1 {{\Request::is('*staff/requisition/purchase*')? 'bg-theme2':''}}">
                    <x-heroicon-o-shopping-cart/>
                    Purchase Requisition
                </x-jet-dropdown-link>
                <x-jet-dropdown-link href="/staff/requisition/store" class="border-b border-l pl-1 flex items-center gap-1 {{\Request::is('*staff/requisition/store*')? 'bg-theme2':''}}">
        ...
        <div class="pl-1">
            ...
            <div class="pl-4">
                <x-jet-dropdown-link href="/staff/approval/open" data-turbo="false" class="border-b border-l pl-1 flex items-center gap-1 {{\Request::is('*/approval/open')? 'bg-theme2':''}}">
                ...
                <x-jet-dropdown-link href="/staff/approval/approved" data-turbo="false" class="border-b border-l borderx-t pl-1 flex items-center gap-1  {{\Request::is('*/approval/approved')? 'bg-theme2':''}}">
                    <x-heroicon-o-clipboard-check/>
                    Approved Documents
                </x-jet-dropdown-link>
                <x-jet-dropdown-link href="/staff/approval/rejected" data-turbo="false" class="border-l pl-1 flex items-center gap-1  {{\Request::is('*/approval/rejected')? 'bg-theme2':''}}">
        ...
        @if(session('authUser')['CEO'])
            <div class="pl-1 border-t">
                ...
                <div class="pl-4">
                    <x-jet-dropdown-link href="/staff/ceo/master-roll" data-turbo="false" class="border-l pl-1 flex items-center gap-1  {{\Request::is('*/ceo/master-roll')? 'bg-theme2':''}}">
                        <x-heroicon-o-users/>
                        Payroll Master Roll
                    </x-jet-dropdown-link>
                </div>
        ...
        @if(session('authUser')['HOD'] != null)
            <div class="pl-1 border-t">
                ...
                <div class="pl-4">
                    <x-jet-dropdown-link href="/staff/hod/employee" data-turbo="false" class="border-l pl-1 flex items-center gap-1  {{\Request::is('*/hod/staff')? 'bg-theme2':''}}">
                        <x-heroicon-o-users/>
                        Department Staff
                    </x-jet-dropdown-link>
                    <x-jet-dropdown-link href="/staff/hod/employee?status=onLeave" data-turbo="false" class="border-l border-t pl-1 flex items-center gap-1  {{\Request::is('*/hod/staff?status=*')? 'bg-theme2':''}}">
                        <x-heroicon-o-users/>
                        Staff on Leave
                    </x-jet-dropdown-link>
                </div>
