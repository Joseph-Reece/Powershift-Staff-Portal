...
return [
    ...
    'errors' => [
        'default' => 'Oops! something went wrong. Please try again. If the error persists, kindly contact the system administrator for help.',
        'persists' => ' Please try again and if the problem persists, kindly contact the IT office for help.',
    ],
    'googleCaptchaKey' => '**',
    'googleAnalyticsId' => '**',
